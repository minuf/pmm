...
public class CrearBD extends SQLiteOpenHelper{
	...
	/*String crearColegios = "CREATE TABLE centros (" +
	...
	String crearPersonal = "CREATE TABLE personal (" +
    		"cod_centro   SMALLINT NOT NULL," +
	...
	String crearProfesores = "CREATE TABLE profesores (" +
            "cod_centro   SMALLINT NOT NULL," +
            "dni          INT UNSIGNED NOT NULL," +
            "apellidos    VARCHAR(30)," +
	...
	public CrearBD(Context context, String name, CursorFactory factory,
			int version) {
